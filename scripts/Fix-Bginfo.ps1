...
Function Set-WallPaper
{
    ...
    Set-ItemProperty -path 'HKCU:\Control Panel\Desktop\' -name Wallpaper -value "C:\ludus\background\$current_color.bgi"
...
foreach ($computer in $computers) {
    ...
    Set-Content -Path "\\$hostname\C$\ludus\background\set-bg.ps1" -Force $newscript
}

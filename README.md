...
* [**Disable-Autologon.ps1**](scripts/Disable-Autologon.ps1): This is an optional script that will disable autologon on the win2019 server and the two workstations.**Run this as a domain admin from the DC**.
